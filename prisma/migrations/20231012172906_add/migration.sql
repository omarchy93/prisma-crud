...
-- AddForeignKey
ALTER TABLE `postCategory` ADD CONSTRAINT `postCategory_categoryId_fkey` FOREIGN KEY (`categoryId`) REFERENCES `categorys`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
